(function () {
  ...
  var galleryUrl = new URL("index.html", frontendRootUrl);
  var faviconUrl = new URL("favicon.svg", frontendRootUrl);
  var pathname = window.location.pathname;
  var isGalleryHome =
    pathname === galleryUrl.pathname ||
    /\/frontend\/$/.test(pathname) ||
    /\/frontend\/index\.html$/.test(pathname);
  ...
  function ensureButton() {
    if (isGalleryHome || document.querySelector(".gallery-home-button")) {
      return;
    }
    ...
    button.href = galleryUrl.href;
    button.setAttribute("aria-label", "Back to gallery");
    button.title = "Back to gallery";
