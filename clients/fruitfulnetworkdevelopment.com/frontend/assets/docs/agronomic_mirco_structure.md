...
## 2) The coordination problem as a risk problem
...
## 3) The cyclical reinvestment effect (reinforcing loop)
...
### 3.1 What “reinvestment” means (practically)
...
## 4) Infrastructure: logistics, social, and physical layers

The reinvestment loop depends on multiple forms of infrastructure that co-evolve.

### 4.1 Logistics infrastructure
...
### 4.3 Physical use-infrastructure
...
## 5) The feasibility window and the critical point
...
### 5.1 Why feasibility can be transitional
...
## 6) Boundary constraints (what limits the cycle)

### 6.1 Distance adjacency
...
### 6.2 Product variety and demand coverage
...
### 6.3 Perishability and time windows
