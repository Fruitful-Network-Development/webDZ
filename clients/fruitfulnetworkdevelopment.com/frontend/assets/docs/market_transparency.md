...
The central claim is a recurring pattern:  
> Increasing the value-density of a market (by improving information, technology, or coordination) often creates an arms race for control and infrastructure. The result can be higher efficiency *and* lower equitability.
...
1. **Mismatch decreases:** fewer wasted movements and fewer “unknown buyer/unknown seller” failures.
2. **Planning improves:** participants can specialize and invest with lower risk.
3. **Prices carry more meaning:** better signals compress uncertainty into actionable values.
...
1) **Early stage (scarce, expensive):**
...
2) **Diffusion stage (affordability and standardization):**
...
3) **Capture stage (infrastructure and control):**
...
## Sources and related reading (project-local)
