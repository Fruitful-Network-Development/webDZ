...
This is presented as a **micro-structure** (small, repeatable mechanisms) that can scale outward until it is limited by:  
(1) physical adjacency radius, and (2) the region’s achievable variety of products.
...
## 3. The adjacency advantage as a cost structure
...
## 4. Transparency as a “market microstructure” for food
...
## 5. The reinvestment flywheel and the “critical point”
...
1) **Better sell-through certainty** reduces the perceived risk of overproduction.  
2) Reduced risk enables **reinvestment** (tools, cold storage, wash/pack, small processing, labor stability).  
3) Reinvestment increases **reliability** (consistent quality, consistent availability windows).  
4) Reliability increases **repeat purchasing** and reduces buyer coordination cost.  
5) Repeat purchasing further increases sell-through certainty.
...
## 6. Why transparency pushes toward variety
...
## 7. Why the incentive can favor regenerative practice
...
## 8. Why monocrop models remain competitive (and where)
...
## 9. Scaling limits: adjacency radius and achievable variety
...
## 10. Related topics (out of scope here)
...
## References (conceptual parallels)
