...
class ConsoleDataContract:
    ...
    def _fetch_admin_console(
        ...
        conspectus_payloads = self._store.fetch_contract_payloads(
            "portal_configuration",
            include_all_ingest=True,
        )
        conspectus = [
        ...
        beneficiary_payloads = self._store.fetch_contract_payloads(
            "identity_access",
            include_all_ingest=True,
        )
        beneficiaries = [
        ...
        correspondence_entries = self._store.fetch_correspondence_entries()
        ...
        return {
            ...
            "correspondence": correspondence_entries,
        }